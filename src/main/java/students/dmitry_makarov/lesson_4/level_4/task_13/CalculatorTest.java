...
class CalculatorTest {
    public static void main(String[] args) {
        ...
        calculatorTest.maxNumberTestAb();
        calculatorTest.maxNumberTestaB();
        calculatorTest.maxNumberTestAB();
    }
    ...
    public void maxNumberTestAb (){
        ...
        if (realResult == expectedResult){
            System.out.println("Max number (A) test is OK");
        }
        else  {
            System.out.println("Max number (A) test FAIL");
        }
    }
    ...
    public void maxNumberTestaB (){
        ...
        int realResult = calculator.maxNumber(firstNumber, secondNumber);
        if (realResult == expectedResult){
            System.out.println("Max number (B) test is OK");
        }
        else  {
            System.out.println("Max number (B) test FAIL");
        }
    }
    ...
    public void maxNumberTestAB (){
        ...
        int realResult = calculator.maxNumber(firstNumber, secondNumber);
        if (realResult == expectedResult){
            System.out.println("Max number (A=B) test is OK");
        }
        else  {
            System.out.println("Max number (A=B) test FAIL");
        }
    }
}
