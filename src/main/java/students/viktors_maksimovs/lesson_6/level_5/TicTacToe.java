...
class TicTacToe {
    ...
    public boolean isWinPositionForHorizontals(int[][] field, int playerToCheck) {
        ...
        if (field[0][0] == playerToCheck && field[0][1] == playerToCheck && field[0][2] == playerToCheck) {
            ...
            return field[2][0] == playerToCheck && field[2][1] == playerToCheck && field[2][2] == playerToCheck;
    }
    ...
    public boolean isWinPositionForVerticals(int[][] field, int playerToCheck) {
        if (field[0][0] == playerToCheck && field[1][0] == playerToCheck && field[2][0] == playerToCheck) {
            ...
            return field[0][2] == playerToCheck && field[1][2] == playerToCheck && field[2][2] == playerToCheck;
    }
